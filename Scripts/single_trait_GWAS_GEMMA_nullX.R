...
fwrite(as.data.frame(MAF[i,]),file = sprintf('nullX_MAF_chr%02d.txt',chr),row.names=T,col.names=T,sep=',',na = 'NA')
fwrite(as.data.frame(beta_hat[i,]),file = sprintf('nullX_beta_hat_chr%02d.txt',chr),row.names=T,col.names=T,sep=',',na = 'NA')
fwrite(as.data.frame(SE[i,]),file = sprintf('nullX_SE_chr%02d.txt',chr),row.names=T,col.names=T,sep=',',na = 'NA')
fwrite(as.data.frame(p_wald[i,]),file = sprintf('nullX_p_wald_chr%02d.txt',chr),row.names=T,col.names=T,sep=',',na = 'NA')
